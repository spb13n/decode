...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 1745.4542510662652; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -3168.172199772192; // x position of the perpendicular encoder (in tick units)
    }
